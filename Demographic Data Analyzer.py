...
def calculate_demographic_data(print_data=True):
    ...
    higher_education_rich = round((higher_education['education'].count() / df[df['education'].isin(['Bachelors', 'Masters', 'Doctorate'])]['education'].count())*100, 1)
    lower_education_rich = round(lower_education['education'].count()/df[~(df['education'].isin(['Bachelors', 'Masters', 'Doctorate']))]['education'].count()*100, 1)
    ...
    rich_percentage = round(num_min_workers['education'].count() / df[df['hours-per-week']==min_work_hours]['hours-per-week'].count()*100,1)
